...
def generate_copyright(language="cpp"):
    c = comment[language] + " "
    copy_str = list()
    copy_str.append(c + "Copyright {}-{}".format(copyright_initial_year, copyright_end_year) + "\n")
    copy_str.append(c + "\n")
...
if __name__ == "__main__":
    ...
    if Nfileschanged > 0 and only_diff:
        print("     Program run with the --diff option. {} files would be changed.".format(Nfileschanged))
